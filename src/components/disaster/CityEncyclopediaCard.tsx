...
// Simplified to Traditional Chinese Data with Background Images (Local Assets)
...
export default function CityEncyclopediaCard({ cityName }: CityEncyclopediaCardProps) {
    ...
    return (
        <div className="luxury-card w-full rounded-[32px] overflow-hidden z-20 h-full min-h-[420px] flex flex-col relative group">
            {/* Background Image Layer */}
            <div
                className="absolute inset-0 z-0 opacity-10 dark:opacity-20 pointer-events-none grayscale transition-opacity duration-700"
                style={{
            ...
            <AnimatePresence mode="wait">
                ...
                >
                    ...
                    <div className="flex flex-col gap-4 shrink-0">
                        ...
                        <div className="flex flex-wrap gap-2">
                            {data.tags.map(tag => (
                                <span
                                    key={tag}
                                    className="px-3 py-1.5 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 text-sm font-medium rounded-full"
                                >
                                    {tag}
                                </span>
                            ))}
                    ...
                    {/* Content: Description & Climate - Flex grow to fill space */}
                    <div className="flex-1 flex flex-col justify-center gap-6 py-6">
                        <p className="text-lg text-gray-600 dark:text-gray-300 leading-loose tracking-wide">
                            {data.description}
                        </p>
                    ...
                    <div className="flex justify-end shrink-0 pt-2">
                        <a
                            ...
                            className="group flex items-center gap-1.5 text-sm font-medium text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors"
                        >
